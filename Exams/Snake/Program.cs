...
namespace Snake
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // въвеждаме си nakeRow snakeCol за да определим позицияте на змията
            int snakeRow = -1;
            int snakeCol = -1;

            // въвеждаме си долните 4 променливи за да сетнем burrows
            ...
            //след като сме премесили змията, поставяме . на предишната й позиция
